...
- REVISION: Menghapus duplikasi rendering mulut (blok 218-252 asli).
  Sekarang mulut hanya digambar satu kali per frame, menghemat
  4 alokasi permukaan transparan dan perhitungan CPU yang sia-sia.
"""
